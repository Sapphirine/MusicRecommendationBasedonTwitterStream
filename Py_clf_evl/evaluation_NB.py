...
# based on http://scikit-learn.org/stable/tutorial/text_analytics/working_with_text_data.html#training-a-classifier
...
#test and classfier and evaluate
y_pred = NB_model.predict(X_test)
scores = NB_model.score(X_test, y_test)
c_scores = cross_val_score(NB_model, 
                           corpus_data_tfidf, 
                           train_data_df.Sentiment )
